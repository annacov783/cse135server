...
print "<br/><br/>";
print "<a href=\"/cgi-bin/hw2/perl/perl-sessions-2.pl\">Session Page 2</a><br/>";
print "<a href=\"/hw2/perl-cgiform.html\">Perl CGI Form</a><br />";
print "<form style=\"margin-top:30px\" action=\"/cgi-bin/hw2/perl/perl-destroy-session.pl\" method=\"get\">";
